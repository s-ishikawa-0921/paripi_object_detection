"""
Usage:
    python create_tf_record.py --annotations_dir=`pwd`/annotations --images_dir=`pwd`/images --output_dir=`pwd`/data/ --label_map_path=`pwd`/data/paripi_label_map.pbtxt
"""
...
def main(_):
    ...
    train_output_path = os.path.join(FLAGS.output_dir, 'paripi_train.record')
    val_output_path = os.path.join(FLAGS.output_dir, 'paripi_val.record')
